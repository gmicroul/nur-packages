...
let
  ...
  self = rec {
    ...
    wechat_dev_tools_fhs_appimage =
      callPackage ./uncategorized-DataEraserC/wechat_dev_tools_fhs_appimage
        { };
    wechat_dev_tools_fhs_bin = callPackage ./uncategorized-DataEraserC/wechat_dev_tools_fhs_bin { };
    Adobe_Photoshop_CS6_appimage =
      callPackage ./uncategorized-DataEraserC/Adobe_Photoshop_CS6_appimage
        { };
    Adobe_Illustrator_CS6_appimage =
      callPackage ./uncategorized-DataEraserC/Adobe_Illustrator_CS6_appimage
        { };
    wechat_dev_tools_appimage = callPackage ./uncategorized-DataEraserC/wechat_dev_tools_appimage { };
    escrcpy_deb = callPackage ./uncategorized-DataEraserC/escrcpy_deb { };
    escrcpy_appimage = callPackage ./uncategorized-DataEraserC/escrcpy_appimage { };
    wechat_dev_tools_bin = callPackage ./uncategorized-DataEraserC/wechat_dev_tools_bin { };
    qtscrcpy_git = pkgs.libsForQt5.callPackage ./uncategorized-DataEraserC/qtscrcpy_git { };
    waybar_bluetooth_battery_parse =
      callPackage ./uncategorized-DataEraserC/waybar_bluetooth_battery_parse
        { };
    llqqnt = callPackage ./uncategorized-DataEraserC/llqqnt { };
    CrossOver = callPackage ./uncategorized-DataEraserC/CrossOver {
      iUnderstandThatReplacingMoltenVKAndDXVKIsNotSupportedByCodeWeaversAndWillNotBotherThemForSupport =
        true;
    };
    fhs = callPackage ./uncategorized-DataEraserC/fhs { };
    # Usage:
    # nur-program-learning.packages.${pkgs.system}.xcursor-genshin-nahida
    xcursor-genshin-nahida = callPackage ./uncategorized-DataEraserC/xcursor-genshin-nahida { };
    MIO_KITCHEN_bin = callPackage ./uncategorized-DataEraserC/MIO_KITCHEN_bin { };
    XiaoMiToolV2 = callPackage ./uncategorized-DataEraserC/XiaoMiToolV2 { };
    watt-toolkit_2 = callPackage ./uncategorized-DataEraserC/watt-toolkit_2 { };
    clang_dev_env = callPackage ./uncategorized-DataEraserC/clang_dev_env { };
    clang_dev_env_fhs = callPackage ./uncategorized-DataEraserC/clang_dev_env_fhs { };
    cudatoolkit_dev_env = callPackage ./uncategorized-DataEraserC/cudatoolkit_dev_env { };
    cudatoolkit_dev_env_fhs = callPackage ./uncategorized-DataEraserC/cudatoolkit_dev_env_fhs { };
    # vmware-workstation = callPackage ./uncategorized-DataEraserC/vmware-workstation { };
    # clash-nyanpasu = callPackage ./uncategorized-DataEraserC/clash-nyanpasu { };
    AppimageLauncher_deb =
      pkgs.libsForQt5.callPackage ./uncategorized-DataEraserC/AppimageLauncher_deb
        { };
    buffybox = callPackage ./uncategorized-DataEraserC/buffybox { };
    buffyboard = callPackage ./uncategorized-DataEraserC/buffyboard { };
    c001apk-flutter = callPackage ./uncategorized-DataEraserC/c001apk-flutter { };
    PiliPalaX = callPackage ./uncategorized-DataEraserC/PiliPalaX { };
    hkdm = callPackage ./uncategorized-DataEraserC/hkdm { };
    ttyescape = callPackage ./uncategorized-DataEraserC/ttyescape { };
    v2dat = callPackage ./uncategorized-DataEraserC/v2dat { };
    v2ray-rules-dat = callPackage ./uncategorized-DataEraserC/v2ray-rules-dat { inherit v2dat; };
  };
in
self
